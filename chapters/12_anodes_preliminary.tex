...
To resolve the potential of the single electrodes, a micro-reference electrode can be used in compact cell \ref{raccichiniCriticalReviewReference2019}, the typical format of battery cells.
...
Additionally, the strong increase in high-frequency resistance and in the charge-transfer arc between 1C and 2C suggests an increas of homic drop due to mass transport limitation. 
...
\marginpar{
    \centering
    \includegraphics[width=\marginparwidth]{figures/anodes/SiCN_post_mortem.jpg}
...
Indeed Dr. Melzi D'Eril observed lack of reproducibility of the \emph{activation peak} for reversible electrodeposion \cite{derilReversibleSodiumPlating2023}.
