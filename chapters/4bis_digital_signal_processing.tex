...
This chapter introduces the signal processing concepts required to manipulate discrete digital signals, including the discrete Fourier transform, spectral leakage, and noise considerations.
...
When performing an experiment, the scientist measures the values of those quantities with instrumentation at specific points in time.
