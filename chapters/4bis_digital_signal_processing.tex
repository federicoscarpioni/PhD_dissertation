...
The accuracy, resolution, and physical validity of impedance measurements therefore depend not only on the electrochemical system and the applied excitation, but also on the underlying signal processing assumptions.
...
This chapter introduces the signal processing concepts required to manipulate discrete digital signals, including the concept Fourier transform, spectral leakage, and noise considerations.
