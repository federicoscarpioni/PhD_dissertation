...
\section{Introduction to the combined method}
...
\section{Temporary stationarity of the system}
...
To validate the impedanceobtained with combined STFFT and DMFA method I applied it together with pure DMFA on all frequencies components for the same dataset.
[Put the figure]
[Caluclate the difference in absolute Ohms between the two points]
The data are acquire over the ?discharge? of a coin cell at C/10, and a frequency range from 1kHz to 10mHz. 
The same cells are used in the measurments discussed in Chapter \ref{chap:coins}.
