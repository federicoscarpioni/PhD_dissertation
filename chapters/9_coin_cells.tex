...
\begin{figure}[!b]
  ...
  \caption{Rational polynomial fitting of dynamic impedance spectra at different states of charge (marked with colours dots) during discharge of cycle 6.
  The figures in the panel after the voltage time series report the impedance data (markers) and fit result (solid black line). Residuals are reported next to each spectrum. The colours of the markers represents the states of charge.}
