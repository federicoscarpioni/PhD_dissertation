...
\section{Why impedance comparison fails}
Whit all the ammount of data, one wants to check how the impedance of the cells are similar or differ. The intuitive way of plotting together impedance sampled at the same soc will not work well...
